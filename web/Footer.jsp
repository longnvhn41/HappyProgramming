            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                        <h2 class="footer-heading"><a href="#" class="logo">INDUSTRIAL SOCIETY AND ITS FUTURE</a></h2>
                        <p>The Industrial Revolution and its consequences have been a disaster for the human race. 
                            ...
                            and have inflicted severe damage on the natural world.</p>
                        <a href="https://www.washingtonpost.com/wp-srv/national/longterm/unabomber/manifesto.text.htm">read more <span class="ion-ios-arrow-round-forward"></span></a>
                    </div>
                    <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                    ...
                    <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                        ...
                        <div class="tagcloud">
                            ...
                            <a href="#" class="tag-cloud-link">trauma</a>
                            <a href="#" class="tag-cloud-link">suffering</a>
                            <a href="#" class="tag-cloud-link">revolution</a>
                            <a href="#" class="tag-cloud-link">freedom</a>
                            <a href="#" class="tag-cloud-link">happiness</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-lg-8">
                            ...
                            <p class="copyright">
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made by <a href="https://youtu.be/dQw4w9WgXcQ" target="_blank">Group 3</a>
                            </p>
                        </div>
