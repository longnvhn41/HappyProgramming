                                    ...
                                    <td>
                                        <c:if test="${o.status == 2}">
                                            <form action="RequestController?service=mentorFinish" method="post">
                                                ...
                                                <input style="width: 100px;" class="mb-1 btn btn-success" type="submit" value="Finish" id="submit" onclick ="return confirm('Do you want to finish this request?')">
                                            </form>
                                            <form action="RequestController?service=mentorCancel" method="post">
                                                <input type="hidden" value="${o.id}" name="requestId">
                                                <input style="width: 100px;" class="mb-1 btn btn-danger" type="submit" value="Cancel" id="submit" onclick ="return confirm('Do you want to cancel this request?')">
                                            </form>
                                        </c:if>
