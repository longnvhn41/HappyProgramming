...
<html>
    ...
    <div class="wrapper bg-white mt-sm-5">
        ...
        <div class="row py-2">
            ...
            <input type="radio" name="status" value="1"  ${sessionScope.user.gender==1?"checked":""}/> Male
            <input type="radio" name="status" value="0"  ${sessionScope.user.gender==0?"checked":""} /> Female
        </div>
        <div class="row py-2">
        ...
        <div class="row py-2">
            <div><a href="UserController?service=update&id=${sessionScope.u.id}">Update</a>
        </div>         
        </div>
        </form>
        </div>
