...
<html>
    ...
    <form class="col-12" action="UserController" method="POST">  
        ...
        <div class="row py-2">
            ...
            <input type="radio" name="gender" value="<%=user.getGender()%>"  ${sessionScope.user.gender==1?"checked":""}/> Male
            <input type="radio" name="gender" value="<%=user.getGender()%>"  ${sessionScope.user.gender==0?"checked":""} /> Female
        </div>
        <div class="row py-2">
